...
func EventHandler() func(context.Context, *sql.Tx, eventbus.Event) error {
	return func(ctx context.Context, tx *sql.Tx, event eventbus.Event) error {
		...
		switch event.Type {
		case "payment.created", "ledger.reserved", "payment.succeeded", "payment.failed", "payment.funds_returned", "payment.return.succeeded", "payment.refund.succeeded", "payment.refund.failed":
		default:
			return nil
		}
		var tenantID string
