...
func (submissionFailureProvider) Submit(context.Context, settlement.SettlementRequest) (settlement.SettlementResult, error) {
	return settlement.SettlementResult{}, &settlement.ProviderError{Message: "insufficient balance", Code: "submission_failed", Retryable: false}
}
