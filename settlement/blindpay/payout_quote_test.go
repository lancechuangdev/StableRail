...
func TestQuoteServiceRejectsInsufficientManagedWalletBalance(t *testing.T) {
	...
	_, err = service.Create(context.Background(), PayoutQuoteRequest{IdempotencyKey: "idem-1", TenantID: "tenant-1", BankAccountID: "ba_test", ManagedWalletID: "bl_test", DestinationCurrency: "BRL", CurrencyType: "sender", AmountMinor: 2500})
